...
export default function LookingAheadSection() {
  return (
    <div className="flex flex-col items-center border-b border-[#27272a] bg-[#18181b] px-4 md:px-6 lg:px-14 pb-16 pt-12 md:pb-20 md:pt-16 lg:pb-24 lg:pt-20 xl:pb-[145px] xl:pt-[100px]">
