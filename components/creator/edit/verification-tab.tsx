    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="border-b border-black/8 pb-[17px]">
        ...
        <p className="text-[13px] text-[#6c757d]">
          Verified creators get a blue checkmark and access to premium analytics tools.
        </p>
      </div>

      {/* Info Banner */}
      <div className="flex gap-4 items-start p-[17px] bg-[#eff6ff] border border-[#dbeafe] rounded-lg">
        <div className="shrink-0">
          <CircleAlert className="w-5 h-5 text-[#1e40af]" />
        </div>
        <div className="flex flex-col gap-[3.25px] flex-1">
          <h4 className="text-[14px] font-semibold text-[#1e40af]">
            Verification Criteria
          </h4>
          <p className="text-[13px] text-[#1e3a8a] leading-[19.5px]">
            To be eligible, your account must be authentic, unique, and active. Please complete the checklist below to
          ...
          type="button"
          className="shrink-0 bg-black text-white text-[13px] font-semibold px-4 py-2 h-auto rounded-full hover:bg-[#1e3a8a]"
        >
          Get Verified
        </Button>
      </div>
