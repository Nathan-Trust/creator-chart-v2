  ...
  return (
    <div className="bg-[#282f43] relative w-full max-w-162.5 p-4 lg:p-8 rounded-md overflow-hidden">
      ...
      <div className="relative z-10">
        {/* Title */}
        <h2 className="text-2xl lg:text-[40px] font-extrabold text-white leading-snug lg:leading-[1.2] mb-4 lg:mb-6">
          Global
          <br />
          Rankings
        </h2>
        ...
        {/* Subtitle */}
        <p className="text-xs lg:text-[14px] font-semibold text-white mb-4 lg:mb-6">
        ...
        {/* Divider */}
        <div className="h-px bg-white/30 mb-4 lg:mb-6" />

        {/* Coverage Status */}
        <div className="mb-6 lg:mb-8">
          <p className="text-sm lg:text-[16px] font-bold text-white/70 mb-2 lg:mb-3">
            COVERAGE STATUS
          </p>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 lg:gap-3">
              ...
              <span className="text-sm lg:text-[16px] font-medium text-white">
